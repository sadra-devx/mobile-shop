  ...
  return (
    <section className="relative overflow-hidden bg-zinc-50 dark:bg-zinc-900">
      ...
      <div className="pointer-events-none absolute inset-x-0 -top-40 h-[680px]">
        <div className="absolute -right-24 -top-24 h-[420px] w-[420px] animate-[drift1_16s_ease-in-out_infinite] rounded-full bg-indigo-300/40 blur-3xl dark:bg-indigo-600/20" />
        <div className="absolute right-1/3 top-0 h-[380px] w-[380px] animate-[drift2_20s_ease-in-out_infinite] rounded-full bg-violet-300/35 blur-3xl dark:bg-violet-600/15" />
        <div className="absolute left-0 top-20 h-[340px] w-[340px] animate-[drift3_18s_ease-in-out_infinite] rounded-full bg-cyan-200/40 blur-3xl dark:bg-cyan-500/10" />
      ...
      <div className="relative mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 px-4 pb-16 pt-32 sm:px-6 lg:grid-cols-2 lg:gap-8 lg:px-10 lg:pb-24 lg:pt-40">
        ...
        <div>
          <span
            className={`inline-flex items-center gap-2 rounded-full border border-indigo-200 bg-indigo-50 px-4 py-1.5 text-sm font-medium text-indigo-700 transition-all duration-700 dark:border-indigo-800 dark:bg-indigo-950/50 dark:text-indigo-300 ${
              loaded ? "translate-y-0 opacity-100" : "translate-y-3 opacity-0"
            }`}
          >
            <Smartphone className="h-3.5 w-3.5" />
            ارسال رایگان بالای {toPersianDigits(2)} میلیون تومان
          </span>

          <h1 className="mt-5 text-4xl font-extrabold leading-[1.25] tracking-tight text-zinc-900 dark:text-white sm:text-5xl lg:text-6xl">
            {words.map((word, i) => (
          ...
          <p
            className={`mt-5 max-w-md text-base leading-8 text-zinc-500 transition-all delay-300 duration-700 dark:text-zinc-400 sm:text-lg ${
              loaded ? "translate-y-0 opacity-100" : "translate-y-3 opacity-0"
            }`}
          >
          ...
          <div
            className={`mt-10 grid grid-cols-3 gap-4 border-t border-zinc-200 pt-6 transition-all delay-700 duration-700 dark:border-zinc-800 sm:max-w-md ${
              loaded ? "translate-y-0 opacity-100" : "translate-y-3 opacity-0"
            }`}
          >
            {stats.map((s) => (
        ...
        >
          <div
            className="relative h-[300px] w-[150px] animate-[float_4s_ease-in-out_infinite] rounded-[2.2rem] border border-zinc-200 bg-zinc-900 shadow-2xl shadow-zinc-400/40 transition-transform duration-150 ease-out dark:border-zinc-700 dark:shadow-black/50 sm:h-[360px] sm:w-[180px]"
            style={{
          ...
          {/* نشان شناور اعتماد */}
          <div className="absolute -left-2 bottom-8 flex items-center gap-2 rounded-2xl border border-zinc-200 bg-white/90 px-4 py-2.5 shadow-lg backdrop-blur-sm dark:border-zinc-700 dark:bg-zinc-800/90 sm:-left-6">
            ...
            <div>
              ...
              <p className="text-[11px] text-zinc-500 dark:text-zinc-400">
                {toPersianDigits(18)} ماه ضمانت
              </p>
            </div>
          </div>
          <div className="absolute -right-2 top-6 flex items-center gap-2 rounded-2xl border border-zinc-200 bg-white/90 px-4 py-2.5 shadow-lg backdrop-blur-sm dark:border-zinc-700 dark:bg-zinc-800/90 sm:-right-6">
